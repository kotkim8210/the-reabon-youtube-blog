...
const productConfigs: Record<string, ProductConfig> = {
  ...
  kolrabi: {
    title: '콜라비·미니밤호박(전 옵션)·홍감자·백도딱딱이복숭아 2·4kg·청사과(제주다팜)',
    description: '취급품목: 콜라비·미니밤호박(보우짱 로얄과, 2026-08-17부터 전 옵션 제주다팜)·홍감자·백도딱딱이복숭아 2·4kg·청사과(아오리사과) 제주다팜 발주서 생성 + 운송장번호 입력 · 홍감자 매칭: 중 1kg→중 2kg, 대 3kg→특 3kg, 대 5kg→특 5kg (2026-07 쥬얼리 품절로 이관) · 백도딱딱이복숭아 중과·대과 2·4kg → 발주명 "딱딱이 복숭아 {등급} {kg}kg" (2026-08-12 재입고, 발주 정상) · 청사과 소과·중소과·대과 2·3·4·5kg → 제주다팜 판매옵션명 그대로 발주 · 초당옥수수·애플초당옥수수·성주참외는 명이나물(쥬얼리) 메뉴',
    icon: '🥬',
    bgClass: 'bg-green-50',
    order: {
      title: '콜라비·미니밤호박·홍감자·백도딱딱이복숭아 2·4kg·청사과 발주서 생성',
      icon: '📋',
    ...
    tracking: {
      title: '콜라비·미니밤호박·홍감자·백도딱딱이복숭아 2·4kg·청사과 운송장번호 입력',
      icon: '📦',
