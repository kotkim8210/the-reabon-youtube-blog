...
const productConfigs: Record<string, ProductConfig> = {
  ...
  myeongi: {
    title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+홍감자+미니밤호박+거반도납작복숭아+대극천복숭아',
    description: '쥬얼리프룻 발주서 생성 + 운송장번호 입력 · 취급품목: 명이나물·애플초당옥수수·초당옥수수·망고수박·수박·성주참외·신비복숭아·홍감자·미니밤호박(보우짱 로얄과 3·5·10kg, 1kg은 제주다팜 메뉴)·거반도 납작복숭아(500g·1kg·2kg)·대극천 복숭아(소과 1kg)',
    icon: '🌿',
    bgClass: 'bg-green-50',
    order: {
      title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+홍감자+미니밤호박+거반도납작복숭아+대극천복숭아 발주서 생성',
      icon: '📋',
    ...
    tracking: {
      title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+홍감자+미니밤호박+거반도납작복숭아+대극천복숭아 운송장번호 입력',
      icon: '📦',
