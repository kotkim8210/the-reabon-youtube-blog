...
const productConfigs: Record<string, ProductConfig> = {
  ...
  kolrabi: {
    title: '콜라비·미니밤호박(전 옵션)·홍감자·백도딱딱이복숭아 2·4kg·홍로사과·햇 배 선물세트(제주다팜)',
    description: '취급품목: 콜라비·미니밤호박(보우짱 로얄과, 2026-08-17부터 전 옵션 제주다팜)·홍감자·백도딱딱이복숭아 2·4kg·청사과(아오리사과)·햇 배 선물세트 제주다팜 발주서 생성 + 운송장번호 입력 · 홍감자 매칭: 중 1kg→중 2kg, 대 3kg→특 3kg, 대 5kg→특 5kg (2026-07 쥬얼리 품절로 이관) · 백도딱딱이복숭아 중과·대과 2·4kg → 발주명 "딱딱이 복숭아 {등급} {kg}kg" (2026-08-12 재입고, 발주 정상) · 홍로사과(가을햇사과) 소과·중소과·중대과·대과 1.5·2·3·4·5kg → 제주다팜 판매옵션명 그대로 발주 (청사과는 2026-08-27 제이비티 메뉴로 이관) · 햇 배 선물세트 대과·특대과 5·7.5kg(보자기 동봉/미동봉) → 제주다팜 구성상품명으로 발주 (2026-09 신규) · 초당옥수수·애플초당옥수수·성주참외는 명이나물(쥬얼리) 메뉴',
    icon: '🥬',
    bgClass: 'bg-green-50',
    order: {
      title: '콜라비·미니밤호박·홍감자·백도딱딱이복숭아 2·4kg·홍로사과·햇 배 선물세트 발주서 생성',
      icon: '📋',
      ...
      tossDateRange: true,
      tossDefaultDays: 1,
      tossDateTitle: '토스 주문 수집 (제주다팜 콜라비·미니밤호박·홍감자·백도딱딱이복숭아 2·4kg·홍로사과)',
      tossDateHint: '기본 2일(어제~오늘) 토스 콜라비·미니밤호박·홍감자·백도딱딱이복숭아 2·4kg·홍로사과 주문을 제주다팜 발주서에 합칩니다. 백도 1kg은 명이(쥬얼리) 메뉴. 배송중·송장입력 건은 자동 제외. (추가발주는 "오늘", 안 합치려면 "수집안함")',
    },
    tracking: {
      title: '콜라비·미니밤호박·홍감자·백도딱딱이복숭아 2·4kg·홍로사과·햇 배 선물세트 운송장번호 입력',
      icon: '📦',
  ...
  myeongi: {
    title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+거반도납작복숭아+대극천복숭아+백도딱딱이복숭아+피자두',
    description: '쥬얼리프룻 발주서 생성 + 운송장번호 입력 · 취급품목: 명이나물·애플초당옥수수·초당옥수수·망고수박·수박·성주참외·신비복숭아·거반도 납작복숭아(500g·1kg·2kg)·대극천 복숭아(소과 1kg)·백도 딱딱이복숭아(중과·대과 1kg만; 2·4kg은 콜라비(제주다팜) 메뉴로 이관)·피자두(1·2·3kg) · 홍감자는 2026-07부터 콜라비(제주다팜) 메뉴로 이관',
    icon: '🌿',
    bgClass: 'bg-green-50',
    order: {
      title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+거반도납작복숭아+대극천복숭아+백도딱딱이복숭아+피자두 발주서 생성',
      icon: '📋',
    ...
    tracking: {
      title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+거반도납작복숭아+대극천복숭아+백도딱딱이복숭아+피자두 운송장번호 입력',
      icon: '📦',
  ...
  tomato: {
    title: '대저토마토·남해땅두릅·신비복숭아·청사과',
    description: '발주서 생성 + 운송장번호 입력 · 청사과(아오리) 소과·중소과·대과 → 제이비티 발주(2026-08-27 제주다팜에서 이관, 쿠팡 대과는 제이비티 중과로 발주) · 홍로사과는 콜라비(제주다팜) 메뉴 · 초당옥수수는 콜라비(제주다팜) 메뉴로 이동',
    icon: '🍅',
    bgClass: 'bg-red-50',
    order: {
      title: '발주서 생성',
    ...
    tracking: {
      title: '대저토마토·남해땅두릅·신비복숭아·청사과 운송장번호 입력',
      icon: '📦',
