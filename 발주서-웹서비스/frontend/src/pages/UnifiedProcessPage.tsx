...
const productConfigs: Record<string, ProductConfig> = {
  ...
  kolrabi: {
    ...
    description: '취급품목: 콜라비·미니밤호박(보우짱 로얄과) 1kg·홍감자 제주다팜 발주서 생성 + 운송장번호 입력 · 홍감자 매칭: 중 1kg→중 2kg, 대 3kg→특 3kg, 대 5kg→특 5kg (2026-07 쥬얼리 품절로 이관) · 미니밤호박 3·5·10kg과 초당옥수수·애플초당옥수수·성주참외는 명이나물(쥬얼리) 메뉴',
    icon: '🥬',
    bgClass: 'bg-green-50',
    order: {
      title: '콜라비·미니밤호박 1kg·홍감자 발주서 생성',
      icon: '📋',
      ...
      tossDateRange: true,
      tossDefaultDays: 1,
      tossDateTitle: '토스 주문 수집 (제주다팜 콜라비·미니밤호박·홍감자)',
      tossDateHint: '기본 2일(어제~오늘) 토스 콜라비·미니밤호박 1kg·홍감자 주문을 제주다팜 발주서에 합칩니다. 미니밤호박 3·5·10kg은 명이(쥬얼리) 메뉴. 배송중·송장입력 건은 자동 제외. (추가발주는 "오늘", 안 합치려면 "수집안함")',
    },
    tracking: {
      title: '콜라비·미니밤호박 1kg·홍감자 운송장번호 입력',
      icon: '📦',
  ...
  myeongi: {
    ...
    description: '쥬얼리프룻 발주서 생성 + 운송장번호 입력 · 취급품목: 명이나물·애플초당옥수수·초당옥수수·망고수박·수박·성주참외·신비복숭아·미니밤호박(보우짱 로얄과 3·5·10kg, 1kg은 제주다팜 메뉴)·거반도 납작복숭아(500g·1kg·2kg)·대극천 복숭아(소과 1kg)·백도 딱딱이복숭아(중과·대과 1·2·4kg) · 홍감자는 2026-07부터 콜라비(제주다팜) 메뉴로 이관',
    icon: '🌿',
    bgClass: 'bg-green-50',
    order: {
      ...
      tossDateHint: '기본 2일(어제~오늘) 토스 주문(수박·성주참외·신비복숭아 1·2kg·망고수박·백도딱딱이복숭아)을 쥬얼리프룻 발주서에 합칩니다. 홍감자는 콜라비(제주다팜) 메뉴. 신비복숭아 3·4kg은 제이비티 메뉴로. 배송중·송장입력 건은 자동 제외. (추가발주는 "오늘", 안 합치려면 "수집안함")',
    },
    tracking: {
