...
const productConfigs: Record<string, ProductConfig> = {
  ...
  kolrabi: {
    ...
    description: '취급품목: 콜라비·미니밤호박(보우짱 로얄과) 1kg 제주다팜 발주서 생성 + 운송장번호 입력 · 미니밤호박 3·5·10kg과 초당옥수수·애플초당옥수수·성주참외는 명이나물(쥬얼리) 메뉴',
    icon: '🥬',
    bgClass: 'bg-green-50',
    order: {
      title: '콜라비·미니밤호박 1kg 발주서 생성',
      icon: '📋',
  ...
  myeongi: {
    title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+홍감자+미니밤호박+거반도납작복숭아+대극천복숭아+백도딱딱이복숭아',
    description: '쥬얼리프룻 발주서 생성 + 운송장번호 입력 · 취급품목: 명이나물·애플초당옥수수·초당옥수수·망고수박·수박·성주참외·신비복숭아·홍감자·미니밤호박(보우짱 로얄과 3·5·10kg, 1kg은 제주다팜 메뉴)·거반도 납작복숭아(500g·1kg·2kg)·대극천 복숭아(소과 1kg)·백도 딱딱이복숭아(중과·대과 1·2·4kg)',
    icon: '🌿',
    bgClass: 'bg-green-50',
    order: {
      title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+홍감자+미니밤호박+거반도납작복숭아+대극천복숭아+백도딱딱이복숭아 발주서 생성',
      icon: '📋',
      ...
      tossDateHint: '기본 2일(어제~오늘) 토스 주문(수박·성주참외·신비복숭아 1·2kg·망고수박·홍감자·백도딱딱이복숭아)을 쥬얼리프룻 발주서에 합칩니다. 신비복숭아 3·4kg은 제이비티 메뉴로. 배송중·송장입력 건은 자동 제외. (추가발주는 "오늘", 안 합치려면 "수집안함")',
    },
    tracking: {
      title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+홍감자+미니밤호박+거반도납작복숭아+대극천복숭아+백도딱딱이복숭아 운송장번호 입력',
      icon: '📦',
