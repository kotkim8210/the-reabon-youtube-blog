...
const productConfigs: Record<string, ProductConfig> = {
  ...
  kolrabi: {
    title: '콜라비·미니밤호박 1kg·홍감자·백도딱딱이복숭아 2·4kg·청사과(제주다팜)',
    description: '취급품목: 콜라비·미니밤호박(보우짱 로얄과) 1kg·홍감자·백도딱딱이복숭아 2·4kg·청사과(아오리사과) 제주다팜 발주서 생성 + 운송장번호 입력 · 홍감자 매칭: 중 1kg→중 2kg, 대 3kg→특 3kg, 대 5kg→특 5kg (2026-07 쥬얼리 품절로 이관) · 백도딱딱이복숭아 중과·대과 2·4kg → 발주명 "딱딱이 복숭아 {등급} {kg}kg" (2026-08-10 발주 마지막, 시즌아웃) · 청사과 소과·중소과·대과 2·3·4·5kg → 제주다팜 판매옵션명 그대로 발주 · 미니밤호박 3·5·10kg과 초당옥수수·애플초당옥수수·성주참외는 명이나물(쥬얼리) 메뉴',
    icon: '🥬',
    bgClass: 'bg-green-50',
    order: {
      title: '콜라비·미니밤호박 1kg·홍감자·백도딱딱이복숭아 2·4kg·청사과 발주서 생성',
      icon: '📋',
    ...
    tracking: {
      title: '콜라비·미니밤호박 1kg·홍감자·백도딱딱이복숭아 2·4kg·청사과 운송장번호 입력',
      icon: '📦',
  ...
  myeongi: {
    title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+미니밤호박+거반도납작복숭아+대극천복숭아+백도딱딱이복숭아+피자두',
    description: '쥬얼리프룻 발주서 생성 + 운송장번호 입력 · 취급품목: 명이나물·애플초당옥수수·초당옥수수·망고수박·수박·성주참외·신비복숭아·미니밤호박(보우짱 로얄과 3·5·10kg, 1kg은 제주다팜 메뉴)·거반도 납작복숭아(500g·1kg·2kg)·대극천 복숭아(소과 1kg)·백도 딱딱이복숭아(중과·대과 1kg만; 2·4kg은 콜라비(제주다팜) 메뉴로 이관)·피자두(1·2·3kg) · 홍감자는 2026-07부터 콜라비(제주다팜) 메뉴로 이관',
    icon: '🌿',
    bgClass: 'bg-green-50',
    order: {
      title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+미니밤호박+거반도납작복숭아+대극천복숭아+백도딱딱이복숭아+피자두 발주서 생성',
      icon: '📋',
    ...
    tracking: {
      title: '명이나물+애플초당옥수수+초당옥수수+망고수박+수박+성주참외+신비복숭아+미니밤호박+거반도납작복숭아+대극천복숭아+백도딱딱이복숭아+피자두 운송장번호 입력',
      icon: '📦',
